...
{
    public static class XqListExtensions
    {
        /// <summary>
        /// 根据<paramref name="selector"/>，返回对应的索引值
        /// </summary>
        ...
        /// <summary>
        /// 在列表最前面，增加<paramref name="item"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="item">被增加的项</param>
        ...
        /// <summary>
        /// 在列表中<paramref name="existingItem"/>的后面，增加<paramref name="item"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>所选择的项后面增加<paramref name="item"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
        ...
        /// <summary>
        /// 在列表中，<paramref name="existingItem"/>项前面增加<paramref name="item"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="existingItem"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>所选择的项前面增加<paramref name="item"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>选择项，并通过<paramref name="item"/>替换
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>选择项，并通过<paramref name="itemFactory"/>替换
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>选择项，并通过<paramref name="item"/>替换第一个
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
        ...
        /// <summary>
        /// 在列表中，根据<paramref name="selector"/>选择项，并通过<paramref name="itemFactory"/>替换第一个
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source"></param>
        /// <param name="selector"></param>
